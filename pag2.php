...
while(($dati = fgetcsv($file, 0, ";")) !== false){
    ...
    /*$dati_regioni[$regione][$anno] = ($dati_regioni[$regione][$anno] ?? 0) + $utenti/$popolazione[$regione]/100;*/
}
...
<h2>Regionale</h2>
<h3>Per anno</h3>
<canvas id="graficoRegioni" style="max-width: 700px; max-height:375px;"></canvas>
